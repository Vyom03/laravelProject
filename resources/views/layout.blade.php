    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mr-auto">
                <!-- Add Dropdown for Teachers and Admin -->
                ...
                <!-- View Dropdown for logged-in users -->
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="viewDropdown">
                        ...
                        @if(Session::get('role') === 'Teacher' || Session::get('role') === 'Admin')
                            ...
                            <a class="dropdown-item" href="{{ route('grades.index') }}">View Grades</a>
                        @endif

                        @if(Session::get('role') === 'Student')
                            <a class="dropdown-item" href="{{ route('grades.my') }}">My Grades</a>
                        @endif
                    </div>
                </li>
                @endif

                <!-- Export for Teachers/Admin -->
                @if(Session::get('role') === 'Teacher' || Session::get('role') === 'Admin')
                <li class="nav-item">
